import { ID, Student, Status, greetStudent, getArray, Counter, Add, Subtract, Multiply, Divide } from "./models.js";
import { ID_SM, Student_SM, Status_SM, StudentManager_SM, printArray_SM } from "./studentModels.js";
