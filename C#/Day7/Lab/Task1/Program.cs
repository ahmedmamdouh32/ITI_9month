    ...
    Task1
{
    internal class Program
    {
        ...
        /// <summary>
        /// Enum for Security levels with flags
        /// </summary>
        [Flags]
        ...
        /// <summary>
        /// Exception for entering wrong day value
        /// </summary>
        ...
        struct Employee
        {
            ...
            /// <summary>
            /// Employee constructor that recieves all values of class's attributes
            /// </summary>
            /// <param name="ID"></param>
            ...
            public Employee(int ID, decimal Salary, Date HireDate, Gender gender, SecurityLevel securityLevel): this(ID, Salary, HireDate)
            {
                _gender = gender;
            ...
            public override string ToString()
            {
                return $"ID : {_id}, Salary : {String.Format("{0:C}", _salary)}, Hire Date : {_hireDate.ToString()}, Gender : {_gender}, Security Level : {_securityLevel}";
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                employee.gender = (Gender)Enum.Parse(typeof(Gender),Console.ReadLine().ToLower());
                Console.WriteLine("Enter Employee Security level : ");
                employee.securityLevel = (SecurityLevel)Enum.Parse(typeof(SecurityLevel), Console.ReadLine().ToLower(), true);
                Console.WriteLine("Special employee : \n" + employee);
            ...
            Date EmployeeHireDate = new Date(1,5,2002);
            Employee[] EmpArr = new Employee[]
            {
                //int ID, decimal Salary, Date HireDate, Gender gender, SecurityLevel securityLevel
                new Employee(ID:1, Salary:2000, HireDate:EmployeeHireDate,gender:Gender.male,securityLevel:SecurityLevel.DBA),
                new Employee(ID:2, Salary:12000, HireDate:EmployeeHireDate,gender:Gender.female,securityLevel:SecurityLevel.guest),
                new Employee(ID:3, Salary:21000, HireDate:EmployeeHireDate,gender:Gender.male,
                securityLevel:SecurityLevel.DBA^SecurityLevel.guest^SecurityLevel.Developer^SecurityLevel.secretary)
            };
