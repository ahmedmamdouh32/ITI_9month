...
public partial class db34477Context : DbContext
{
    public db34477Context()
    {
    }

    public db34477Context(DbContextOptions<db34477Context> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<student_note> student_notes { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=AHMED\\SQLEXPRESS;Initial Catalog=ITI;Integrated Security=True;Encrypt=True; Trust server certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.EmpID).HasName("PK__Employee__AF2DBA799178C010");
        ...
        modelBuilder.Entity<Student>(entity =>
        {
            entity.ToTable("Student", tb =>
                {
                    tb.HasTrigger("student_table_delete");
                    tb.HasTrigger("student_table_trigger");
                });
